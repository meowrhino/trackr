...
| **3. Backend remisión** 🚧 | Claude | **Parte 1 hecha (2026-07-18, `trackr-api@9be6a71`)**: cola `verifactu_queue` en D1 + `POST/GET /v1/verifactu/registros` (idempotente por huella, lote atómico, solo personas; 22 unit + 9 E2E). Queda: cliente SOAP mTLS contra preproducción, cron por obligado con control de flujo, XML validado contra XSD oficiales, y el frontend que vacíe su cola local contra el endpoint — el SOAP bloqueado por Fase 2 (certificado). | 2-4 días restantes |
