...
for item in index.html customer-journey.html css js journey vendor examples analytics navicon.png og-image.png manifest.json sw.js icon-192.png icon-512.png robots.txt sitemap.xml; do
