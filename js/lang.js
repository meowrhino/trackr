...
const LANGS = {
  ...
  es: {
    ...
    'billing.editPayment': 'Editar cobro',
    ...
    'welcome.claim': 'Tu gestión y facturación de autónomo. Local-first y sin cuenta obligatoria; con sincronización cifrada opcional. Simple y gratis.',
    ...
    'cfg.theme': 'Tema',
    'cfg.calendar': 'Calendario',
    'cfg.calStartHour': 'Hora inicio del día',
    'cfg.calStartHourHelp': 'A qué hora arranca el eje vertical. Útil si tus jornadas son nocturnas.',
    'cfg.fiscalTitle': 'Fiscal (modelos 130 y 303)',
    'cfg.rendAnterior': 'Rendimiento neto del año anterior (€)',
    'cfg.rendAnteriorHelp': 'Para la casilla 13 del modelo 130: si fue ≤ 12.000 € tienes minoración (100/75/50/25 € por trimestre). Primer año de actividad: pon 0. Vacío = sin minoración.',
    'cfg.saldoIva': 'IVA a compensar previo (€)',
    'cfg.saldoIvaHelp': 'Saldo a compensar (casilla 110) que traías de antes de registrar datos en TRACKR. Si empiezas de cero, déjalo vacío.',
    'cfg.eds': 'Estimación directa simplificada — aplicar el 5 % de gastos de difícil justificación',
    ...
    'cfg.vfTitle': 'Verifactu (SIF)',
    'cfg.vfDesc': 'Sistema Informático de Facturación. Cada factura emitida se firma con SHA-256 encadenado y lleva un QR de verificación de la AEAT.',
    'cfg.vfSifId': 'Identificador SIF',
    'cfg.vfVersion': 'Versión del software',
    'cfg.vfFixedNote': 'Identificadores del fabricante. Se actualizan con cada release de TRACKR; no son editables por el usuario.',
    'cfg.vfEnv': 'Entorno de verificación AEAT',
    'cfg.vfEnvProd': 'Producción (www2.agenciatributaria.gob.es)',
    'cfg.vfEnvTest': 'Pruebas (prewww2.aeat.es)',
    'cfg.vfEnabled': 'Verifactu habilitado en facturas',
    'cfg.vfLastHash': 'Último hash',
    'cfg.vfTotalSigned': '{0} facturas firmadas',
    'cfg.vfEmisor': 'NIF emisor',
    'cfg.vfNoEmisor': 'configura tu NIF en datos del emisor',
    'cfg.vfVerifyChain': 'Verificar integridad',
    'cfg.vfChainOk': 'Cadena íntegra · {0} factura(s) verificadas',
    'cfg.vfChainBroken': '⚠ {0} de {1} factura(s) con hash incorrecto — revisa la consola',
    'cfg.vfNothingToVerify': 'Aún no hay facturas firmadas',
    ...
    'din.intraBase': 'Adquis. intracomunitarias (base)',
    'din.intraCuota': 'Adquis. intracomunitarias (cuota)',
    'din.ispNoUEBase': 'ISP proveedores no UE (base)',
    'din.ispNoUECuota': 'ISP proveedores no UE (cuota)',
    'din.intraDedBase': 'Intracomunitarias deducibles (base)',
    'din.intraDedCuota': 'Intracomunitarias deducibles (cuota)',
    'din.infoTitle': 'Informativas (no suman al resultado)',
    'din.box59': 'Servicios a clientes UE',
    'din.box120': 'Servicios fuera de la UE',
    'din.aviso349': 'Hay operaciones intracomunitarias: van también al modelo 349 y requieren NIF-IVA (alta en el ROI).',
    'field.zonaFiscal': 'Zona fiscal',
    'field.nifProveedor': 'NIF del proveedor',
    'field.numFactura': 'Nº de factura',
    'ph.optional': 'opcional',
    'cfg.zonaClientHelp': 'UE o fuera de UE: sus facturas sin IVA van a las casillas informativas del 303 (59/120).',
    'gas.zonaProveedor': 'Proveedor (zona fiscal)',
    'gas.zonaHelp': 'Factura sin IVA español: TRACKR autoliquida el IVA en el 303 (inversión del sujeto pasivo).',
    'exp.title': 'Exportar',
    'exp.jsonBtn': 'Copia de seguridad (JSON)',
    'exp.jsonDesc': 'Todos tus datos en un archivo. Es tu save file: guárdalo donde quieras y reimpórtalo cuando quieras.',
    'exp.librosTitle': 'Libros registro (AEAT)',
    'exp.librosDesc': 'Excel oficial con facturas expedidas y gastos, listo para tu gestoría o para importar en Renta Web, Pre303 y modelo 130. Siempre desde el 1 de enero (así lo exige el formato).',
    'exp.year': 'Ejercicio',
    'exp.upTo': 'Hasta',
    'exp.fullYear': 'Año completo',
    'exp.librosBtn': 'Descargar libros (Excel)',
    'exp.needNif': 'Falta tu NIF en Configuración → Datos del emisor.',
    'exp.noData': 'No hay facturas ni gastos en ese periodo.',
    'exp.librosDone': 'Libros generados: {0} facturas y {1} gastos',
    'cfg.actTipo': 'Tipo de actividad (libros AEAT)',
    'cfg.actTipoA': 'A — Incluida en el IAE',
    'cfg.actTipoB': 'B — No incluida en el IAE',
    'cfg.actCodigo': 'Subtipo de actividad',
    'cfg.act05': 'Resto de actividades profesionales',
    'cfg.act04': 'Profesionales artísticas o deportivas',
    'cfg.act03': 'Resto de actividades empresariales',
    'cfg.act01': 'Arrendadores de bienes inmuebles',
    'cfg.actIAE': 'Grupo o epígrafe del IAE',
    'cfg.actHelp': 'Estos tres campos van en cada fila de los libros registro (Exportar → Libros AEAT). El epígrafe del IAE es el de tu alta en el 036/037.',
    'cfg.vfRemision': 'Remisión a AEAT',
    'cfg.vfRemisionState': '{0} en la cola del servidor · {1} sin encolar',
    'cfg.vfPushNow': 'Encolar ahora',
    'cfg.vfPushed': 'Cola actualizada',
    'cfg.vfNeedsAccount': 'requiere cuenta activa (los registros se encolan al sincronizar)',
    'cfg.vfRemisionNote': 'Los registros esperan en la cola del servidor; el envío a la AEAT se activará cuando el acuerdo de colaboración esté firmado (TODO/15).',
    'zona.es': 'España',
    'zona.ue': 'UE (con NIF-IVA)',
    'zona.noue': 'Fuera de la UE',
    'din.cumulativeNote': 'Acumulado desde el 1 de enero, como el modelo oficial',
    'din.hardToJustify': 'incluye {0} del 5 % de difícil justificación',
    'din.prevPayments': 'Pagos fraccionados anteriores',
    'din.minoracion': 'Minoración por rendimientos bajos',
    'din.prevNegatives': 'Negativos de trimestres anteriores',
    'din.toDeduct': 'A deducir en próximos trimestres',
    'din.negativeQ4': 'Negativa (se recupera en la Renta)',
    'din.result46': 'Resultado régimen general',
    'din.prevBalance': 'Saldo a compensar de periodos anteriores',
    'din.compApplied': 'Compensado este periodo',
    'din.compPending': 'Pendiente para periodos siguientes',
    'din.toCompensate': 'A compensar',
    ...
    'renta.devengoNote': 'Criterio de devengo: por fecha de factura, bases sin IVA',
    'renta.diff': 'Diferencia (ingresos − gastos)',
    'renta.dj': 'Gastos difícil justificación (5 %)',
    'renta.withhold599': 'Retenciones soportadas en facturas',
    'renta.pf604': 'Pagos fraccionados (mod. 130)',
    'renta.c0186': 'Seguridad Social (RETA)',
    'renta.c0192': 'Arrendamientos y cánones',
    'renta.c0194': 'Suministros',
    'renta.c0199': 'Servicios profesionales (gestoría…)',
    'renta.c0200': 'Primas de seguros',
    'renta.c0202': 'Otros servicios exteriores',
    'renta.c0208': 'Amortizaciones',
    'renta.suministrosNote': 'Suministros de vivienda afecta: en la Renta solo es deducible gasto × (m² afectos / m² totales) × 30 %.',
    'renta.dedsIncluded': 'Deducciones del año (ya incluidas en gastos):',
    ...
    'fac.verifactuText': 'Factura verificable en la sede electrónica de la AEAT',
    'fac.compliantWith': 'Cumple RD 1007/2023, Orden HAC/1177/2024',
    ...
    'guide.about.intro': '<p>Trackr es una herramienta <strong>gratuita y abierta</strong> para que autónomos y freelancers lleven el control de sus proyectos, horas, facturas e impuestos — todo desde el navegador. Funciona <strong>sin cuenta</strong>, con un archivo de guardado que vive en tu equipo; y si quieres usarlo en varios dispositivos, puedes activar una <strong>sincronización cifrada de conocimiento cero</strong> (ni nosotros ni el servidor podemos leer tus datos).</p>',
    ...
    'journey.moveTo': 'Mover a…',
    'journey.compact': 'Compactar',
    'journey.expand': 'Expandir',
    'journey.collapse': 'Plegar',
    'journey.expandCol': 'Desplegar',
  ...
  en: {
    ...
    'billing.editPayment': 'Edit payment',
    ...
    'welcome.claim': 'Freelance project & invoice management. Local-first, no account required; optional encrypted sync. Simple and free.',
    ...
    'cfg.calStartHour': 'Day start hour',
    'cfg.calStartHourHelp': 'When the vertical axis starts. Useful for night shifts.',
    'cfg.fiscalTitle': 'Tax settings (forms 130 & 303)',
    'cfg.rendAnterior': 'Last year’s net yield (€)',
    'cfg.rendAnteriorHelp': 'For box 13 of form 130: if it was ≤ €12,000 you get a reduction (€100/75/50/25 per quarter). First year of activity: enter 0. Empty = no reduction.',
    'cfg.saldoIva': 'Prior VAT balance to offset (€)',
    'cfg.saldoIvaHelp': 'Balance to offset (box 110) carried from before your TRACKR data. Starting fresh? Leave empty.',
    'cfg.eds': 'Simplified direct estimation — apply the 5 % hard-to-justify expense allowance',
    'cfg.clients': 'Clients',
    ...
    'cfg.vfTitle': 'Verifactu (SIF)',
    'cfg.vfDesc': 'Spanish Invoicing System. Each invoice is signed with chained SHA-256 and includes an AEAT verification QR code.',
    'cfg.vfSifId': 'SIF identifier',
    'cfg.vfVersion': 'Software version',
    'cfg.vfFixedNote': 'Manufacturer identifiers. Updated with each TRACKR release; not user-editable.',
    'cfg.vfEnv': 'AEAT verification environment',
    'cfg.vfEnvProd': 'Production (www2.agenciatributaria.gob.es)',
    'cfg.vfEnvTest': 'Test (prewww2.aeat.es)',
    'cfg.vfEnabled': 'Verifactu enabled on invoices',
    'cfg.vfLastHash': 'Latest hash',
    'cfg.vfTotalSigned': '{0} signed invoices',
    'cfg.vfEmisor': 'Issuer tax ID',
    'cfg.vfNoEmisor': 'set your tax ID in issuer details first',
    'cfg.vfVerifyChain': 'Verify chain integrity',
    'cfg.vfChainOk': 'Chain intact · {0} invoice(s) verified',
    'cfg.vfChainBroken': '⚠ {0} of {1} invoice(s) have invalid hash — check console',
    'cfg.vfNothingToVerify': 'No signed invoices yet',
    ...
    'din.intraBase': 'Intra-EU acquisitions (base)',
    'din.intraCuota': 'Intra-EU acquisitions (VAT)',
    'din.ispNoUEBase': 'Reverse charge, non-EU suppliers (base)',
    'din.ispNoUECuota': 'Reverse charge, non-EU suppliers (VAT)',
    'din.intraDedBase': 'Deductible intra-EU acquisitions (base)',
    'din.intraDedCuota': 'Deductible intra-EU acquisitions (VAT)',
    'din.infoTitle': 'Informational boxes (not added to the result)',
    'din.box59': 'Services to EU clients',
    'din.box120': 'Services outside the EU',
    'din.aviso349': 'There are intra-EU operations: they also go on form 349 and require an EU VAT number (ROI registration).',
    'field.zonaFiscal': 'Tax zone',
    'field.nifProveedor': 'Supplier tax ID',
    'field.numFactura': 'Invoice number',
    'ph.optional': 'optional',
    'cfg.zonaClientHelp': 'EU or outside the EU: their VAT-free invoices go to the informational boxes of form 303 (59/120).',
    'gas.zonaProveedor': 'Supplier (tax zone)',
    'gas.zonaHelp': 'Invoice without Spanish VAT: TRACKR self-assesses the VAT on form 303 (reverse charge).',
    'exp.title': 'Export',
    'exp.jsonBtn': 'Backup (JSON)',
    'exp.jsonDesc': 'All your data in one file. It is your save file: keep it anywhere and re-import it anytime.',
    'exp.librosTitle': 'Tax record books (AEAT)',
    'exp.librosDesc': 'Official Excel with issued invoices and expenses, ready for your advisor or to import into Renta Web, Pre303 and form 130. Always from January 1st (the format requires it).',
    'exp.year': 'Year',
    'exp.upTo': 'Up to',
    'exp.fullYear': 'Full year',
    'exp.librosBtn': 'Download books (Excel)',
    'exp.needNif': 'Your tax ID is missing in Settings → Issuer.',
    'exp.noData': 'No invoices or expenses in that period.',
    'exp.librosDone': 'Books generated: {0} invoices and {1} expenses',
    'cfg.actTipo': 'Activity type (AEAT books)',
    'cfg.actTipoA': 'A — Included in IAE',
    'cfg.actTipoB': 'B — Not included in IAE',
    'cfg.actCodigo': 'Activity subtype',
    'cfg.act05': 'Other professional activities',
    'cfg.act04': 'Artistic or sports professionals',
    'cfg.act03': 'Other business activities',
    'cfg.act01': 'Property landlords',
    'cfg.actIAE': 'IAE group or heading',
    'cfg.actHelp': 'These three fields go on every row of the record books (Export → AEAT books). The IAE heading is the one on your 036/037 registration.',
    'cfg.vfRemision': 'AEAT submission',
    'cfg.vfRemisionState': '{0} in the server queue · {1} not queued yet',
    'cfg.vfPushNow': 'Queue now',
    'cfg.vfPushed': 'Queue updated',
    'cfg.vfNeedsAccount': 'requires an active account (records are queued on sync)',
    'cfg.vfRemisionNote': 'Records wait in the server queue; sending to AEAT will be enabled once the collaboration agreement is signed.',
    'zona.es': 'Spain',
    'zona.ue': 'EU (with VAT number)',
    'zona.noue': 'Outside the EU',
    'din.cumulativeNote': 'Cumulative since January 1st, as in the official form',
    'din.hardToJustify': 'includes {0} from the 5 % hard-to-justify allowance',
    'din.prevPayments': 'Prior quarterly payments',
    'din.minoracion': 'Low-income reduction',
    'din.prevNegatives': 'Prior quarters’ negative results',
    'din.toDeduct': 'To deduct in coming quarters',
    'din.negativeQ4': 'Negative (recovered in the annual return)',
    'din.result46': 'General regime result',
    'din.prevBalance': 'Balance carried from prior periods',
    'din.compApplied': 'Offset applied this period',
    'din.compPending': 'Pending for future periods',
    'din.toCompensate': 'To carry forward',
    ...
    'renta.devengoNote': 'Accrual basis: by invoice date, VAT-exclusive amounts',
    'renta.diff': 'Difference (income − expenses)',
    'renta.dj': 'Hard-to-justify expenses (5 %)',
    'renta.withhold599': 'Withholdings on invoices',
    'renta.pf604': 'Quarterly prepayments (form 130)',
    'renta.c0186': 'Social Security (RETA)',
    'renta.c0192': 'Rent and leases',
    'renta.c0194': 'Utilities',
    'renta.c0199': 'Professional services (accountant…)',
    'renta.c0200': 'Insurance premiums',
    'renta.c0202': 'Other external services',
    'renta.c0208': 'Depreciation',
    'renta.suministrosNote': 'Home-office utilities: only expense × (m² used / total m²) × 30 % is deductible in the annual return.',
    'renta.dedsIncluded': 'This year’s deductions (already included in expenses):',
    ...
    'fac.verifactuText': 'Invoice verifiable on the AEAT electronic office',
    'fac.compliantWith': 'Compliant with RD 1007/2023, Order HAC/1177/2024',
    ...
    'guide.about.intro': '<p>Trackr is a <strong>free and open</strong> tool for freelancers to manage projects, hours, invoices and taxes — all from your browser. It works <strong>with no account</strong>, with a save file that lives on your device; and if you want to use it across devices, you can turn on <strong>zero-knowledge encrypted sync</strong> (neither we nor the server can read your data).</p>',
    ...
    'journey.moveTo': 'Move to…',
    'journey.compact': 'Compact',
    'journey.expand': 'Expand',
    'journey.collapse': 'Collapse',
    'journey.expandCol': 'Expand',
  ...
  ca: {
    ...
    'billing.editPayment': 'Editar cobrament',
    ...
    'welcome.claim': 'La teva gestió i facturació d’autònom. Local-first i sense compte obligatori; amb sincronització xifrada opcional. Simple i gratis.',
    ...
    'cfg.theme': 'Tema',
    'cfg.calendar': 'Calendari',
    'cfg.calStartHour': 'Hora inici del dia',
    'cfg.calStartHourHelp': 'A quina hora comença l’eix vertical. Útil per a torns nocturns.',
    'cfg.fiscalTitle': 'Fiscal (models 130 i 303)',
    'cfg.rendAnterior': 'Rendiment net de l\'any anterior (€)',
    'cfg.rendAnteriorHelp': 'Per a la casella 13 del model 130: si va ser ≤ 12.000 € tens minoració (100/75/50/25 € per trimestre). Primer any d\'activitat: posa 0. Buit = sense minoració.',
    'cfg.saldoIva': 'IVA a compensar previ (€)',
    'cfg.saldoIvaHelp': 'Saldo a compensar (casella 110) que duies d\'abans de registrar dades a TRACKR. Si comences de zero, deixa-ho buit.',
    'cfg.eds': 'Estimació directa simplificada — aplicar el 5 % de despeses de difícil justificació',
    'cfg.clients': 'Clients',
    ...
    'cfg.vfTitle': 'Verifactu (SIF)',
    'cfg.vfDesc': 'Sistema Informàtic de Facturació. Cada factura emesa es firma amb SHA-256 encadenat i porta un QR de verificació de l\'AEAT.',
    'cfg.vfSifId': 'Identificador SIF',
    'cfg.vfVersion': 'Versió del software',
    'cfg.vfFixedNote': 'Identificadors del fabricant. S\'actualitzen amb cada release de TRACKR; no els pot editar l\'usuari.',
    'cfg.vfEnv': 'Entorn de verificació AEAT',
    'cfg.vfEnvProd': 'Producció (www2.agenciatributaria.gob.es)',
    'cfg.vfEnvTest': 'Proves (prewww2.aeat.es)',
    'cfg.vfEnabled': 'Verifactu habilitat a les factures',
    'cfg.vfLastHash': 'Últim hash',
    'cfg.vfTotalSigned': '{0} factures firmades',
    'cfg.vfEmisor': 'NIF emissor',
    'cfg.vfNoEmisor': 'configura el teu NIF a dades de l\'emissor',
    'cfg.vfVerifyChain': 'Verificar integritat',
    'cfg.vfChainOk': 'Cadena íntegra · {0} factura/es verificades',
    'cfg.vfChainBroken': '⚠ {0} de {1} factura/es amb hash incorrecte — revisa la consola',
    'cfg.vfNothingToVerify': 'Encara no hi ha factures firmades',
    ...
    'din.intraBase': 'Adquis. intracomunitàries (base)',
    'din.intraCuota': 'Adquis. intracomunitàries (quota)',
    'din.ispNoUEBase': 'ISP proveïdors no UE (base)',
    'din.ispNoUECuota': 'ISP proveïdors no UE (quota)',
    'din.intraDedBase': 'Intracomunitàries deduïbles (base)',
    'din.intraDedCuota': 'Intracomunitàries deduïbles (quota)',
    'din.infoTitle': 'Informatives (no sumen al resultat)',
    'din.box59': 'Serveis a clients UE',
    'din.box120': 'Serveis fora de la UE',
    'din.aviso349': 'Hi ha operacions intracomunitàries: van també al model 349 i requereixen NIF-IVA (alta al ROI).',
    'field.zonaFiscal': 'Zona fiscal',
    'field.nifProveedor': 'NIF del proveïdor',
    'field.numFactura': 'Núm. de factura',
    'ph.optional': 'opcional',
    'cfg.zonaClientHelp': 'UE o fora de la UE: les seves factures sense IVA van a les caselles informatives del 303 (59/120).',
    'gas.zonaProveedor': 'Proveïdor (zona fiscal)',
    'gas.zonaHelp': 'Factura sense IVA espanyol: TRACKR autoliquida l\'IVA al 303 (inversió del subjecte passiu).',
    'exp.title': 'Exportar',
    'exp.jsonBtn': 'Còpia de seguretat (JSON)',
    'exp.jsonDesc': 'Totes les teves dades en un arxiu. És el teu save file: guarda\'l on vulguis i reimporta\'l quan vulguis.',
    'exp.librosTitle': 'Llibres registre (AEAT)',
    'exp.librosDesc': 'Excel oficial amb factures expedides i despeses, llest per a la teva gestoria o per importar a Renta Web, Pre303 i model 130. Sempre des de l\'1 de gener (el format ho exigeix).',
    'exp.year': 'Exercici',
    'exp.upTo': 'Fins a',
    'exp.fullYear': 'Any complet',
    'exp.librosBtn': 'Descarregar llibres (Excel)',
    'exp.needNif': 'Falta el teu NIF a Configuració → Dades de l\'emissor.',
    'exp.noData': 'No hi ha factures ni despeses en aquest període.',
    'exp.librosDone': 'Llibres generats: {0} factures i {1} despeses',
    'cfg.actTipo': 'Tipus d\'activitat (llibres AEAT)',
    'cfg.actTipoA': 'A — Inclosa a l\'IAE',
    'cfg.actTipoB': 'B — No inclosa a l\'IAE',
    'cfg.actCodigo': 'Subtipus d\'activitat',
    'cfg.act05': 'Resta d\'activitats professionals',
    'cfg.act04': 'Professionals artístiques o esportives',
    'cfg.act03': 'Resta d\'activitats empresarials',
    'cfg.act01': 'Arrendadors de béns immobles',
    'cfg.actIAE': 'Grup o epígraf de l\'IAE',
    'cfg.actHelp': 'Aquests tres camps van a cada fila dels llibres registre (Exportar → Llibres AEAT). L\'epígraf de l\'IAE és el de la teva alta al 036/037.',
    'cfg.vfRemision': 'Remissió a l\'AEAT',
    'cfg.vfRemisionState': '{0} a la cua del servidor · {1} sense encuar',
    'cfg.vfPushNow': 'Encuar ara',
    'cfg.vfPushed': 'Cua actualitzada',
    'cfg.vfNeedsAccount': 'requereix compte actiu (els registres s\'encuen en sincronitzar)',
    'cfg.vfRemisionNote': 'Els registres esperen a la cua del servidor; l\'enviament a l\'AEAT s\'activarà quan l\'acord de col·laboració estigui signat.',
    'zona.es': 'Espanya',
    'zona.ue': 'UE (amb NIF-IVA)',
    'zona.noue': 'Fora de la UE',
    'din.cumulativeNote': 'Acumulat des de l\'1 de gener, com el model oficial',
    'din.hardToJustify': 'inclou {0} del 5 % de difícil justificació',
    'din.prevPayments': 'Pagaments fraccionats anteriors',
    'din.minoracion': 'Minoració per rendiments baixos',
    'din.prevNegatives': 'Negatius de trimestres anteriors',
    'din.toDeduct': 'A deduir en propers trimestres',
    'din.negativeQ4': 'Negativa (es recupera a la Renda)',
    'din.result46': 'Resultat règim general',
    'din.prevBalance': 'Saldo a compensar de períodes anteriors',
    'din.compApplied': 'Compensat aquest període',
    'din.compPending': 'Pendent per a períodes següents',
    'din.toCompensate': 'A compensar',
    ...
    'renta.devengoNote': 'Criteri de meritació: per data de factura, bases sense IVA',
    'renta.diff': 'Diferència (ingressos − despeses)',
    'renta.dj': 'Despeses difícil justificació (5 %)',
    'renta.withhold599': 'Retencions suportades en factures',
    'renta.pf604': 'Pagaments fraccionats (mod. 130)',
    'renta.c0186': 'Seguretat Social (RETA)',
    'renta.c0192': 'Arrendaments i cànons',
    'renta.c0194': 'Subministraments',
    'renta.c0199': 'Serveis professionals (gestoria…)',
    'renta.c0200': 'Primes d\'assegurances',
    'renta.c0202': 'Altres serveis exteriors',
    'renta.c0208': 'Amortitzacions',
    'renta.suministrosNote': 'Subministraments d\'habitatge afecte: a la Renda només és deduïble despesa × (m² afectes / m² totals) × 30 %.',
    'renta.dedsIncluded': 'Deduccions de l\'any (ja incloses a despeses):',
    ...
    'fac.verifactuText': 'Factura verificable a la seu electrònica de l\'AEAT',
    'fac.compliantWith': 'Compleix RD 1007/2023, Ordre HAC/1177/2024',
    ...
    'guide.about.intro': '<p>Trackr és una eina <strong>gratuïta i oberta</strong> perquè autònoms i freelancers portin el control dels seus projectes, hores, factures i impostos — tot des del navegador. Funciona <strong>sense compte</strong>, amb un fitxer de guardat que viu al teu equip; i si vols fer-lo servir en diversos dispositius, pots activar una <strong>sincronització xifrada de coneixement zero</strong> (ni nosaltres ni el servidor podem llegir les teves dades).</p>',
...
function setLang(code) {
  ...
  ZONA_FISCAL = {
    es: t('zona.es'), ue: t('zona.ue'), noue: t('zona.noue')
  };
