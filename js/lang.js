...
const LANGS = {
  ...
  es: {
    ...
    'din.toPay': 'A pagar',
    'din.toRefund': 'A devolver',
    'din.deductibleExp': 'Gastos deducibles',
    'din.netProfit': 'Rendimiento neto',
    'din.withholdings': 'Retenciones',
    'din.vatRate': 'Tipo IVA',
    'din.vatChargedAmt': 'Cuota IVA repercutido',
    'din.inputBase': 'Base IVA soportado',
    'din.inputVat': 'Cuota IVA soportado',
    'din.twentyPercent': '20 % rendimiento',
    'din.copyBoxes': 'Copiar casillas',
    'din.copied': 'Casillas copiadas al portapapeles',
    'din.noInvoicesThisPeriod': 'Sin facturación en este periodo',
    'din.missingDateWarn': '{0} proyecto(s) con facturación pero sin fecha de factura — no entran en el cálculo:',
    ...
    'gas.baseAmount': 'Importe base (€)',
    'gas.baseAmountHelp': 'Se pre-rellena en cada entrada nueva. Útil para cuotas que normalmente repiten importe.',
    'gas.recurringDay': 'Día del mes (1-31)',
    'gas.thisMonth': 'Registrar este mes',
    'gas.thisMonthShort': 'Este mes',
    'gas.missingThisMonth': 'Falta entrada de este mes',
    'gas.entryAdded': 'Entrada añadida ✓',
    ...
    'guide.billing.payments.body': '<p>Cada proyecto puede tener <strong>múltiples cobros</strong>. No hace falta que el cliente pague todo de una vez.</p><ul><li>En el detalle del proyecto verás la sección <strong>Cobros</strong> con una barra de progreso.</li><li>Pulsa <strong>"Registrar cobro"</strong> para añadir un pago parcial con fecha y cantidad.</li><li>O usa <strong>"Marcar pagado"</strong> (en la tarjeta del dashboard y en el detalle) para registrar el pendiente al total con fecha de hoy en un solo clic.</li><li>Cuando la suma de cobros alcanza el total de la factura, el proyecto se marca como <strong>pagado</strong> automáticamente.</li><li>En el dashboard verás el flag <strong>"parcial"</strong> en proyectos con cobros pero no totalmente pagados.</li></ul><div class="guide-tip">Los cobros parciales aparecen en Dineros y en el Calendario en su fecha real. Los impuestos trimestrales se prorratean según la fecha de cada cobro.</div>',
    ...
    'guide.money.expenses.body': '<p>Crea <strong>categorías de gasto</strong> (ej: software, alquiler, autónomos) y añade entradas con <strong>base, IVA y total</strong> (los tres campos por separado, como en una factura real). Marca los gastos como <strong>desgravables</strong> para que se reflejen en los cálculos fiscales.</p><p><strong>Categorías desgravables</strong>: autónomos, alquiler oficina, suministros, software, formación, material, transporte, seguros, asesoría, amortización.</p><div class="guide-tip">El desglose base/IVA/total se usa tal cual en los modelos 303 y 130, sin recalcular. Para facturas en divisas (ChatGPT, Manus…) introduce el importe que Stripe te aplicó en EUR para que cuadre con el banco.</div>',
  ...
  en: {
    ...
    'din.toPay': 'To pay',
    'din.toRefund': 'To refund',
    'din.deductibleExp': 'Deductible expenses',
    'din.netProfit': 'Net profit',
    'din.withholdings': 'Withholdings',
    'din.vatRate': 'VAT rate',
    'din.vatChargedAmt': 'Output VAT amount',
    'din.inputBase': 'Input VAT base',
    'din.inputVat': 'Input VAT amount',
    'din.twentyPercent': '20 % of net',
    'din.copyBoxes': 'Copy boxes',
    'din.copied': 'Boxes copied to clipboard',
    'din.noInvoicesThisPeriod': 'No invoicing in this period',
    'din.missingDateWarn': '{0} project(s) invoiced but missing invoice date — not in calculation:',
    ...
    'gas.baseAmount': 'Base amount (€)',
    'gas.baseAmountHelp': 'Pre-filled on new entries. Useful for recurring payments with stable amount.',
    'gas.recurringDay': 'Day of month (1-31)',
    'gas.thisMonth': 'Add this month',
    'gas.thisMonthShort': 'This month',
    'gas.missingThisMonth': 'Missing entry for this month',
    'gas.entryAdded': 'Entry added ✓',
    ...
    'guide.money.expenses.body': '<p>Create <strong>expense categories</strong> (e.g. software, rent, freelancer tax) and add entries with <strong>base, VAT and total</strong> (three separate fields, like a real invoice). Mark expenses as <strong>deductible</strong> so they\'re reflected in tax calculations.</p><p><strong>Deductible categories</strong>: freelancer tax, office rent, utilities, software, training, materials, transport, insurance, accountant, depreciation.</p><div class="guide-tip">The base/VAT/total breakdown is used as-is in forms 303 and 130 — no inverse calculation. For foreign-currency invoices (ChatGPT, Manus…) enter the EUR amount that Stripe applied so it matches your bank statement.</div>',
  ...
  ca: {
    ...
    'din.toPay': 'A pagar',
    'din.toRefund': 'A retornar',
    'din.deductibleExp': 'Despeses deduïbles',
    'din.netProfit': 'Rendiment net',
    'din.withholdings': 'Retencions',
    'din.vatRate': 'Tipus IVA',
    'din.vatChargedAmt': 'Quota IVA repercutit',
    'din.inputBase': 'Base IVA suportat',
    'din.inputVat': 'Quota IVA suportat',
    'din.twentyPercent': '20 % rendiment',
    'din.copyBoxes': 'Copiar caselles',
    'din.copied': 'Caselles copiades al porta-retalls',
    'din.noInvoicesThisPeriod': 'Sense facturació en aquest període',
    'din.missingDateWarn': '{0} projecte(s) amb facturació però sense data de factura — no entren al càlcul:',
    ...
    'gas.deductibleBadge': 'desgravable',
    'gas.baseAmount': 'Import base (€)',
    'gas.baseAmountHelp': 'Es preomple a cada nova entrada. Útil per quotes que normalment es repeteixen.',
    'gas.recurringDay': 'Dia del mes (1-31)',
    'gas.thisMonth': 'Registrar aquest mes',
    'gas.thisMonthShort': 'Aquest mes',
    'gas.missingThisMonth': 'Falta entrada d\'aquest mes',
    'gas.entryAdded': 'Entrada afegida ✓',
    ...
    'guide.money.expenses.body': '<p>Crea <strong>categories de despesa</strong> (ex: software, lloguer, autònoms) i afegeix entrades amb <strong>base, IVA i total</strong> (els tres camps per separat, com en una factura real). Marca les despeses com a <strong>desgravables</strong> perquè es reflecteixin als càlculs fiscals.</p><p><strong>Categories desgravables</strong>: autònoms, lloguer oficina, subministraments, software, formació, material, transport, assegurances, assessoria, amortització.</p><div class="guide-tip">El desglossament base/IVA/total s\'usa tal qual als models 303 i 130, sense recalcular. Per a factures en divises (ChatGPT, Manus…) introdueix l\'import que Stripe et va aplicar en EUR perquè quadri amb el banc.</div>',
